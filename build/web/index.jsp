...
<div class="topnav" style="padding-left: 30px">
    ...
    <a class="active" href="index.jsp"><i class="fa fa-home" aria-hidden="true"></i> &nbsp; Main Menu</a>
<a href="login.jsp">Admin Login</a>
<a href="register.jsp">Customer Register Page</a>
 
<h3  align="right" style="font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif'"></h3>
</div>	
<div class="section1" align="center" style="margin-top: 0px; background-color: white" >
 
    <img src="css/123.jpg" width="100%"> 
	  </div>
</div>	
