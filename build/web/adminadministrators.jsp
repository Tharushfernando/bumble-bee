...
<a class="active" href="adminadministrators.jsp">Administrators</a>
...
<h1 class="alert-danger" >Manage Administrators</h1>
 	  
<hr>
<div class="row" style="margin-left: 20px; border-color:#06F; border: thick">
    <div class="col-sm-4">
         <h3 class="alert-danger" >Add Administrators </h3>
  ...
  <div class="col-sm-8">   
      <div class="panel-body">
           <h3 class="alert-danger" >All Administrators </h3>
          <table id="tbl-patients" class="table table-responsive table-bordered" cellpadding="0" width="100%">
              ...
              <tr>
                  ...
                  <td><a href="adminupdate.jsp?id=<%=id%>">Edit</a></td>
                  <td><a href="admindelete.jsp?id=<%=id%>">Delete</a></td>
              </tr>
